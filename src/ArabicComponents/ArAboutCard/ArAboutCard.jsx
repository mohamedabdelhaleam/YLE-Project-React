  ...
  return (
    <div className='flex relative justify-center text-center items-center gap-28 xs:gap-16 flex-col p-4 py-16 xs:py-12 bg-[#FDF8EE] xs:w-[80%]'>
      ...
      <div className='flex justify-center items-center flex-col gap-16 xs:gap-12'>
        <div className="font-['Roboto'] text-2xl font-normal">لوريم إيبسوم بكل بساطة</div>
        <div className="font-['Roboto'] text-xl font-light">لوريم إيبسوم مجرد دمية نص للطباعة والتنضيد صناعة. 
لقد كان لوريم إيبسوم الدمية القياسية للصناعة النص 
منذ القرن الخامس عشر الميلادي ،</div>
      </div>
    </div>
  );
}
