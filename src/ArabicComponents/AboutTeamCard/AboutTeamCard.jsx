  ...
  return (
    <div className='flex justify-center text-center items-center gap-4 flex-col p-8 rounded-md shadow-lg border-2 border-[#E0E6ED]'>
      ...
      <div className='flex justify-center items-center flex-col gap-2'>
        ...
        <div className="font-['Roboto'] text-lg text-[#3B3F5C] font-light">UI is the saddle, the stirrups, & the reins. UX is the feeling you get being able to ride the horse.</div>
      </div>
    </div>
  );
}
